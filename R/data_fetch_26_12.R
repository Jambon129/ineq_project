...
#mittelwert
#hy020 = houseinc
svymean(~houseinc, silc.rh.svy)

#median, top 80, top20, top10
vector <- svyquantile(~houseinc, silc.rh.svy, c(0.5, 0.8, 0.2, 0.9))
vec <- as.data.frame(vector)
#ratio   take vec[2] if satisfied w/out dataframe
ratio<- vector[2] / vector[3]
...
#mittelwert
#hy020 = houseinc
svymean(~posttax, silc.ph_adults)

#median, top 80, top20, top10
vector <- svyquantile(~posttax, silc.ph_adults, c(0.5, 0.8, 0.2, 0.9))
vec <- as.data.frame(vector)
#ratio  
ratio<- vector[2] / vector[3]

#gini
svygini(~posttax , silc.ph_adults)
